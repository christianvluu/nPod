...
//Pod selection
//Building(4)_Floor(2)_POD_ID(1)
const PODS = ["LIBR_B1_POD_0",
              "LIBR_B1_POD_1",
              "LIBR_F0_POD_0",
              "LIBR_F0_POD_1",
              "LIBR_F0_POD_2",
...
const POD_NUM = 0; //Change index for each device
const SSID = "Lville MiFiX"; //Set SSID name
const SSID_PASSWORD = "XXXXXXXX"; //Set SSID password

const DEVICE_OBJ = PODS[POD_NUM];
const DEVICE_ID = "" + PODS[POD_NUM];
const DEVICE_CREDS = "CREDENTIALS_" + PODS[POD_NUM];
